                                                            ...
                                                            <tr>
                                                                <td class="px-6 py-4 whitespace-nowrap">
                                                                    <div class="flex items-center">
                                                                        ...
                                                                        <div class="flex items-center h-5">
                                                                            <input id="permiso_{{ $permiso->id }}" value="{{ $permiso->id }}" name="permission[]" type="checkbox" class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                                                                        </div>
